/* hint
 * (1) lock 3배 확장 후 lock을 중앙으로 배치  
 * (2) key를 4회 회전하며 완전 탐색 
 */
...
public class 자물쇠와열쇠 {
	...
	public static void main(String[] args) {
		...
		int[][] key1 = new int[][]{{0, 0, 0}, {1, 0, 0}, {0, 1, 1}};
		int[][] lock1 = new int[][]{{1, 1, 1}, {1, 1, 0}, {1, 0, 1}};
		System.out.println(s.solution(key1, lock1));

		int[][] key2 = new int[][]{{0, 0}, {1, 0}};
		int[][] lock2 = new int[][]{{1, 1, 1}, {1, 1, 0}, {1, 0, 1}};
		System.out.println(s.solution(key2, lock2));

		int[][] key3 = new int[][]{{0, 0}, {1, 0}};
		int[][] lock3 = new int[][]{{1, 1, 1}, {1, 1, 0}, {1, 1, 1}};
		System.out.println(s.solution(key3, lock3));
